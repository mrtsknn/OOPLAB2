...
namespace OOPLAB2
{
    public partial class Form2 : Form
    {
        ...
        {
            red = cbxRed.Checked ? true : false;
        }

        private void cbxYellow_CheckedChanged(object sender, EventArgs e)
        {
            yellow = cbxyellow.Checked ? true : false;
        }
        private void cbxBlue_CheckedChanged(object sender, EventArgs e)
        {
            blue = cbxBlue.Checked ? true : false;
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            void writeShapes() //şekillerden hangilerinin seçili durumda olduğunu settings.txt'ye kaydeder
            {
                ...
                sw.WriteLine(yellow.ToString());
                sw.WriteLine(blue.ToString());
            }
           /* void writeColors()
            {
        ...
        private void Form2_Load(object sender, EventArgs e) //settings.txt içerisine ayar kaydedilmiş ise o ayarları uygular
        {
            if (File.Exists("settings.txt"))
            {
                ...
                if (lines[5] == "True")
                {
                    cbxyellow.Checked = true;
                }
                if (lines[6] == "True")
                {
                    cbxBlue.Checked = true;
                }
